...
<div class="navbar navbar-fixed-top">
    		<div class="navbar-inner">
				<div class="container">
					<a class="brand"><img src="img/header.png"></img></a>
				</div>    		
    		</div>
    </div>
<?php
	...
	if (!$_GET["noscan"]) {
		...
		<div class='well' align='center'>	
			...
			<form method=get action='".$_SERVER['PHP_SELF']."'>
				...
				if (substr($_SERVER["HTTP_USER_AGENT"], 0, 19) == "Mozilla/5.0 (iPhone") {
					echo "<input type=textbox name=barcode style='height:30px'> <div align='right'><input type=submit value='input' class='btn btn-primary'>";
				} else {
