...
//						AND tdj.username = '$_SESSION[uname]' ORDER BY b.namaBarang";
		...
		while ($x = mysql_fetch_array($hasil1)) {
			...
			echo "<tr>";
			// edited by abufathir:
			echo $_POST['buat'] ? "<td align=left> <input  type=submit 	name=buatpo		value='Buat PO'><input type=submit name=print value='Print' /></td>" : "<td align=left> <input  type=submit 	name=buat		value='Buat RPO'></td>";
