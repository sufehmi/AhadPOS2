...
//						AND tdj.username='$_SESSION[uname]' ORDER BY b.namaBarang";
		...
		while ($x=mysql_fetch_array($hasil1)) {
			...
			<tr <?php echo $ctr % 2 === 0 ? 'class="alt"' : ''; ?>>
				...
				<td align=center><input type='text' class='form-control' class='form-control' name=jumbarang$ctr value=".$x['jumBarang']." size=3></td>
				<td align=right>".number_format($x['hargaBeli'], 0, ',', '.')."</td>
				<td align=right>".number_format(($x['hargaBeli'] * $x['jumBarang']), 0, ',', '.')."</td>";
				// edited by abufathir:		
				//<td></td>
			...
			echo "<tr>";
			// edited by abufathir:
			echo $_POST['buat'] ? "<td align=left> <input type='submit' class='btn btn-default' 	name=buatpo		value='Buat PO'><input type='submit' class='btn btn-default' name=print value='Print' /></td>" : "<td align=left> <input type='submit' class='btn btn-default' 	name=buat		value='Buat RPO'></td>";
			//echo "		<td align=left> <input type='submit' class='btn btn-default' 	name=buat		value='Buat RPO'></td>";
			// end;
			echo "		<td></td>
				<td></td>
				<td></td>
				<td></td>
				<td align=right><input type='submit' class='btn btn-default' 	name=update		value='UPDATE'></td>
				<td></td>
				<td align=right><b>Rp ".number_format($grandtotal, 0, ',', '.')."</b></td>
			</tr>
