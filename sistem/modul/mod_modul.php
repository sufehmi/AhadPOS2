...
case "tambahmodul":
	echo "<h2>Tambah Modul</h2>
		...
		<table>
		<tr><td>Nama Modul</td><td><input type='text' class='form-control' name='namaModul' size=30></td></tr>
		<tr><td>Link</td>	<td><input type='text' class='form-control' name='link' size=30 value='?module='></td></tr>
...
case "editmodul":
	...
	echo "<h2>Edit Modul</h2>
		...
		<table>
		<tr><td>Nama Modul</td>	<td><input type='text' class='form-control' name='namaModul' value='$data[namaModul]'></td></tr>
		<tr><td>Link</td>	<td><input type='text' class='form-control' name='link' size=30 value='$data[link]'></td></tr>";
	if ($data[publish]=='Y'){
