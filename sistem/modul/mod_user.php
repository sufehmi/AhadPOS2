...
if ($_GET[module] == 'ganti_password') {
	...
	<form method=POST action=./aksi.php?module=user&act=update&home=1 name='edituser'>
		...
		<table>
			<tr><td>Nama User</td><td> : <input type=text name='namaUser' size=30 value='<?php echo $data['namaUser']; ?>'></td></tr>
			...
			<tr><td>Username</td><td> : <input type=text name='uname' size=15 value='<?php echo $data['uname']; ?>'></td></tr>
