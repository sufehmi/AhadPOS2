...
ahp_popupheader('barang');

// JqueryUI untuk autocomplete cari barang pada harga banded ?>
...
//	</div>
		...
		<input type='submit' class='btn btn-default' value='Cetak Label / barcode / perubahan harga jual' >
		</form>
		*/
		?>
		<?php
...
//			<br /><br />
		...
		<form class="inline" method=POST action='modul/js_input_retur_barang.php?act=caricustomer' onSubmit="popupform(this, 'INPUT_RETUR_BARANG')">
			<input type='submit' class='btn btn-default' accesskey='r' value='(r) Input Retur Jual'>
		</form>
		...
		<input type='submit' class='btn btn-default' value='Kartu Stok' >
		</form>
		*/
		?>
		<?php
...
//						ORDER BY namaBarang ASC LIMIT $mulai,100 ");
	...
	case "tambahbarang": //========================================================================================================================
		...
		<table>
		<tr><td>Barcode</td><td><input type='text' class='form-control' name='barcode' size=30 value=$_GET[id]></td></tr>
		<tr><td>Nama Barang</td><td><input type='text' class='form-control' name='namaBarang' size=30></td></tr>
		<tr><td>Supplier</td>
	...
	case "cetaklabel1": //========================================================================================================================
		...
		<tr><td><input type='submit' class='btn btn-default' accesskey='l' value='(l) Cetak Label Barang'></td></tr>
	...
	case "cetaklabel2":
		...
		<form method=POST action='modul/mod_barang.php?act=cetaklabel3' onSubmit="popupform(this, 'cetaklabel')">
			...
			<select class='form-control' id="layout-tinggi" name="layout">
			...
			<input type='submit' class='btn btn-default' accesskey='l' value='(l) Cetak Label Barang'>
		</form>
		<?php
		break;
...
//				};
	...
	case "cetakperbarcode": //=============================================================================================
		...
		<div>
			<form action="?module=barang&act=cetakperbarcode&cek=barcode" method="POST">
				...
				<input type='submit' class='btn btn-info' name="cekBarcode" value="Get Barang" />
			</form>
			<form action="?module=barang&act=cetakperbarcode&cek=perubahanhj" method="POST">
				Harga jual berubah sejak:<input type="text" class="form-control" id="tanggal_dari" name="tanggal_dari" value="">
				<input type='submit' class='btn btn-info' name="cekBarcode" value="Get Barang" />
			</form>
			<script>
	...
	<h2>Input Cepat Rak</h2>
		...
		echo "</select></td></tr>
		<tr><td>(b) Barcode</td><td><input type='text' class='form-control' name='barcode' id='barcode' accesskey='b' size=30 value=''>	</td></tr>
	</table>
	...
	case "cetakSO": //========================================================================================================================
		...
		<form method=POST action='modul/mod_barang.php?act=cetakSO2' onSubmit="popupform(this, 'Cetak Stock Opname')">
			<table>
				...
				<tr>
					<td>Kategori</td>
					<td><select class='form-control' name="kategoriId" id="daftar-kategori">
						</select>
					</td>
				</tr>
				<tr>
					<td colspan=2><input type='submit' class='btn btn-default' accesskey='c' value='(c) Cetak Stock Opname' ></td>
				</tr>
			</table>
		</form>
		<script>
	...
	case "inputSO": //========================================================================================================================
		...
		<tr><td colspan=2><input type='submit' class='btn btn-default' accesskey='i' value='(i) Mulai Input Stock Opname' ></td></tr>
			...
			<table class="tabel">
				...
				while ($r= mysql_fetch_array($cari)) :
					...
					<tr class="<?php echo $no % 2=== 0 ? 'alt' : ''; ?>">
						...
						<td class="right">	<input type='text' class='form-control' name='selisih<?php echo $ctr; ?>' size=2 value='0'>	</td>
					</tr>
					<?php
					$no++;
					$ctr++;
				...
				<tr>
					<td colspan=2><input type='submit' class='btn btn-default' value='Input Stock Opname' ></td>
				</tr>
			</table>
			<br />
	...
	case "editbarang": //========================================================================================================================
		...
		<form method=POST action=./aksi.php?module=barang&act=update name='editbarang'>
			...
			<table>
				...
				<tr>
					<td>Harga Jual</td>
					<td><input type='text' class='form-control' name='hargaJual' size=20 value='<?php echo $data['hargaJual']; ?>'></td>
	...
	case "cetakbarang1": //========================================================================================================================
		...
		<form method=GET action='modul/mod_barang.php' onSubmit="popupform(this, 'CETAK_STOCK_BARANG')">
			...
			<table>
				<tr>
					<td>(d) Dari Rak</td>
					<!--<td><input type='text' class='form-control' name=darirak value=1 accesskey='d' size=4></td>-->
					<td>
						<select  class='form-control' name="darirak" id="darirak" class="pilih_rak">							
							<option value='0'>-- Pilih Rak --</option>
							<?php
				...
				<tr>
					<td>Sampai Rak</td>
					<!--<td><input type='text' class='form-control' name=sampairak value=$jumlah_rak size=4></td>-->
					<td>
						<select  class='form-control'  name="sampairak" id="sampairak" class="pilih_rak">													
							<option value='0'>-- Pilih Rak --</option>
							<?php
				...
				<tr>
					<td colspan=2><br /><input type='submit' class='btn btn-default' accesskey='b' value='(b) Cetak Stock Barang'></td>
				</tr>
	...
	<tr>
		<td colspan=2><br /><input type='submit' class='btn btn-default' accesskey='s' value='(s) Submit'></td>
	</tr>
	...
	";
		...
		<input type='submit' class='btn btn-default' accesskey='s' value='(s) Submit'>
		...
		if (isset($_POST['sinkronisasi_harga'])) {
			...
			if ($result) {
				...
				<form method="POST" action="modul/mod_barang.php?act=cetakhargajualsync" onSubmit="popupform(this, 'cetaklabel')">
					...
					<input type='submit' class='btn btn-info' name="cetak" value="Cetak label harga yang disinkronisasi" />
				</form>
				<?php
			}
		}
	...
	case 'diskon':
		...
		<form method="POST">
			<table>
				<tr>
					<td>Tipe Diskon</td>
					<td>
						<select class='form-control' name="diskon_detail[diskon_tipe_id]" id="diskonTipeId">
				...
				<tr>
					<td>Barcode</td>
					<td><input type="text" class="form-control" id="barcode" name="diskon_detail[barcode]" style="margin-right:5px;" /><?php echo isset($errorBarcode) ? $errorBarcode : ''; ?><span id="barcode-info"></span></td>
				</tr>
				<tr>
					<td>Periode</td>
					<td>
						<input type="text" class="form-control" id="tanggal_dari" name="diskon_detail[tanggal_dari]" value="">
						-
						<input type="text" class="form-control" id="tanggal_sampai" name="diskon_detail[tanggal_sampai]" value="">
				...
				<tr>
					<td>Diskon (%)</td>
					<td><input type="text" class="form-control" name="diskon_detail[diskon_persen]" value="0"/></td>
				</tr>
				<tr>
					<td>Diskon @ (Rp)</td>
					<td><input type="text" class="form-control" name="diskon_detail[diskon_rupiah]" value="0"/></td>
				</tr>
				<tr class="show-on-grosir-only">
					<td>Jumlah Barang Minimum</td>
					<td><input type="text" class="form-control" name="diskon_detail[min_item]" value="0"/></td>
				</tr>
				<tr class="show-on-waktu-only">
					<td>Jumlah Barang Maksimum</td>
					<td><input type="text" class="form-control" name="diskon_detail[max_item]" value="0" /></td>
				</tr>
				<tr>
					<td></td>
		...
		<hr />
		<form method="POST">
			<input type='submit' class='btn btn-info' name="auto_nonaktif" value="Auto Non Aktif" title="Me-nonaktifkan diskon-diskon yang sudah expired" />
		</form>
		<table class="tabel">
			<tr>
				<th>Tipe Diskon</th>
	...
	case 'pindahsupplier':
		...
		<form method="POST">
			...
			<select class='form-control' name="idSupplier" id="supplierasal" style="width:30%">
				<?php
			...
			<input type='submit' class='btn btn-default' value='(D)isplay Barang' accesskey='d' name='displayBarang' />
		</form>
		<br />
		<?php
		/*
		...
		*/
		if (isset($_POST['displayBarang'])):
			...
			<form method="POST" action="?module=barang&act=pindahsupplier2">
				...
				<select class='form-control' name="idSupplierTujuan" id="raktujuan" style="width:30%">
					<?php
				...
				<input type='submit' class='btn btn-info' name="pilihBarang" value="Pindahkan Barang" />
			</form>
			<?php
		endif;
		break;
		...
		*/
		if (isset($_POST['displayBarang'])):
			...
			<form method="POST" action="?module=barang&act=pindahrak2">
				...
				<select class='form-control' name="idRakTujuan" id="raktujuan" style="width:30%">
					<?php
...
//	$hasil1=mysql_query($sql);
		...
		<select class='form-control' id="pilih-rak">
			<option value="null">Pilih Rak</option>
			<?php
			while ($rak=mysql_fetch_array($hasil1)) {
				?>
	...
	case 'hargabanded':
		...
		<form method=POST action='?module=barang&act=hargabanded2'>
			<table>
				<tr>
					<td><b>B</b>arcode:</td>
					<td><input type="text" class="form-control" name="barcode" accesskey="b" autofocus="autofocus" id="barcode" autocomplete="off"/></td>
				</tr>
				<tr>
					<td><b>N</b>ama:</td>
					<td><input type="text" class="form-control" name="namabarang" accesskey="n" id="namaBarang" placeholder="Minimal 3 karakter"/></td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right"><input type='submit' class='btn btn-default' value='Submit'></td>
				</tr>
			</table>
		</form>
		<script>
			...
			<form method="POST">
				<table>
					<tr>
						...
						<td><input type="text" class="form-control" disabled="disabled" value="<?php echo number_format($pembelian['hargaBeli'], 0, ',', '.'); ?>"/></td>
					</tr>
					<tr>
						<td>Harga jual satuan</td>
						<td><input type="text" class="form-control" value="<?php echo number_format($dataBarang['hargaJual'], 0, ',', '.'); ?>" disabled="disabled" /></td>
					</tr>
					<tr>
						<td>Qty banded</td>
						<td>
					...
					<tr>
						<td>Total</td>
						<td><input type="text" class="form-control" id="hb-total" value="<?php echo isset($hbQty) ? $hbQty * $dataBarang['hargaJual'] : ''; ?>" disabled="disabled" /></td>
					</tr>
					<tr>
						<td>Harga banded</td>
						<td><input type="text" class="form-control" id="hb-hargabanded" name="harga" value="<?php echo isset($hbHarga) ? $hbHarga * $hbQty : ''; ?>" autocomplete="off"/></td>
					</tr>
					<tr>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><input type='submit' class='btn btn-info' class="tombol" value="(s) Simpan" accept="s"/></td>
					</tr>
				</table>
			</form>
			<script>
		...
		<form method=POST action='?module=barang&act=kartustok2'>
			<table>
				...
				<tr>
					<td>Periode</td>
					<td>
						<input type="text" class="form-control" id="tanggal_dari" name="tanggal[dari]" value="" size="4" placeholder="Optional">
						-
						<input type="text" class="form-control" id="tanggal_sampai" name="tanggal[sampai]" value="" size="4">
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right"><input type='submit' class='btn btn-default' value='Submit'></td>
