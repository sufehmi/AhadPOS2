...
//			<br /><br />
		...
		<form class="inline"  method=POST action='?module=barang&act=uploadfoto'>
...
//            }; // for ($i = 0; $i <= $_POST[ctr]; $i++) {
	...
	case 'uploadfoto':
		?>
		<h2>Upload Foto Barang:</h2>
		<form method=POST action='?module=barang&act=uploadfoto2'>
			<table>
				<tr>
					<td><b>B</b>arcode: </td>
					<td><input type="text" name="barcode" accesskey="b" autofocus="autofocus" id="barcode" autocomplete="off"/></td>
			...
			<form action="aksi.php?module=barang&act=uploadfoto" method="post" enctype="multipart/form-data">
				...
				<table>
					...
					if ($dataFoto && !empty($dataFoto['nama_file'])) {
						...
						<tr>
							<td>Foto:</td>
							<td><img src="<?php echo $imgSrc; ?>" alt=""/></td>
						</tr>
						<?php
					}
					?>
					...
					<tr>
						<td>Keterangan: </td>
						<td><textarea name="keterangan" rows="4" cols="30"><?php echo $dataFoto['keterangan']; ?></textarea></td>
					</tr>
					<tr>
						<td>Dimensi: </td>
						<td><input type="text" name="dimensi" placeholder="p x l x t cm" value="<?php echo $dataFoto['dimensi']; ?>" /></td>
					</tr>
					<tr>
						<td>Berat: </td>
						<td><input type="text" name="berat" placeholder="dalam kg" value="<?php echo $dataFoto['berat']; ?>" /></td>
					</tr>
					<tr>
						<td></td>
