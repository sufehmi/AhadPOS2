...
//				};
	...
	case "cetakperbarcode": // =============================================================================================
		...
		<form action='modul/mod_cetakperbarcode.php?act=printperbarcode' method='POST' onSubmit="popupform(this, 'printperbarcode')">
			...
			<div>
				...
				<input type='submit' class='btn btn-default' name='printBarcode' value='Print' />
			</div>
		</form>
		<?php
		break;
	...
	case "cetakSO": // ========================================================================================================================
		...
		<tr><td colspan=2><input type='submit' class='btn btn-default' accesskey='c' value='(c) Cetak Stock Opname' ></td></tr>
			...
			<table class="tabel">
				...
				while ($r=mysql_fetch_array($cari)) :
					...
					<tr class="<?php echo $no % 2 === 0 ? 'alt' : ''; ?>">
						...
						<td class="right">	<input type='text' class='form-control' class='form-control' name='selisih<?php echo $ctr; ?>' size=2 value='0'>	</td>
					</tr>
					<?php
					$no++;
					$ctr++;
	...
	<tr>
		...
		<tr><td colspan=2><br /><input type='submit' class='btn btn-default' accesskey='b' value='(b) Cetak Stock Barang'></td></tr>
	...
	<tr>
		<td><br /> (t) Pilih Tanggal SO </td>
				<td><br /> : <select class='form-control' name='tanggalSO' accesskey='t'>";
	...
	case "transfer1": // ----------------------------------------------------------------------------
		...
		echo "<h2>Transfer Barang</h2>
			...
			(i) ID Customer : <select class='form-control' name='idCustomer' accesskey='i'>";
	...
	case 'pindahrak':
		...
		<form method="POST">
			...
			<select class='form-control' name="idRak" id="rakasal" style="width:30%">
				<?php
