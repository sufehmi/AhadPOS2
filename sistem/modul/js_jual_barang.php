...
ahp_popupheader('Jual Barang',$add_tohead);
?>
						...
						<tr class="<?php echo $no % 2=== 0 ? 'alt' : ''; ?>">
							...
							<td class="right">
								...
								if ($_SESSION['hakAdmin']) {
									?>
									<a href="#" class="harga-jual pilih" data-type="text" class="form-control" data-pk="<?php echo $data['uid']; ?>" data-url="../aksi.php?module=diskon&act=updatehj" ><?php echo $data['hargaJual']; ?></a>
									<?php
								} else {
									echo $data['hargaJual'];
								}
...
//								}
		...
		<div id="cek-harga" style="
			...
			<form id="form-cek-harga">
				<tr>
					<td rowspan="3">			
						<input type="text" class="form-control" id="cek-harga-barcode" name="cek-harga[barcode]" placeholder="Scan Barcode" autocomplete="off"/><br />
						<input type="text" class="form-control" id="cek-harga-nama" name="cek-harga[nama]" placeholder="Nama Barang (min 3 huruf)"/><br />
					</td>
		...
		<div id="footer" >
			...
			if ($returBeli) {
			?>	
			<a class="tombol" href="js_jual_barang.php?act=carisupplier" accesskey="r" ><u>R</u>eload</a>
			<?php
			} else {
			?>
			<a class="tombol" href="js_jual_barang.php?act=caricustomer<?php echo $transferahad ? '&transferahad=1' : ''; ?>" accesskey="r" ><u>R</u>eload</a>
			...
			<a class="tombol" href="#" id="tombol-self-checkout" accesskey="f" >Sel<u>f</u>Checkout</a>
			<a class="tombol" href="#" id="tombol-nomor-kartu" accesskey="k" ><u>K</u>artu Member</a>
			<a class="tombol" href="#" id="tombol-cek-harga" accesskey="g" >Cek Har<u>g</u>a</a>
					<?php }
					?>
		</div>
		<script>
