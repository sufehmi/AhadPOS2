...
default:
	...
	<div class='list-group table-of-contents'>
			<a class='list-group-item' href='?module=laporan&act=penjualan1'>Laporan Penjualan</a>
			<a class='list-group-item' href='?module=pembelian_barang&act=laporanpembeliantanggal'>Laporan Pembelian per tanggal</a>
			<a class='list-group-item' href='?module=pembelian_barang&act=laporanpembelian'>Laporan Pembelian per supplier</a>
			<a class='list-group-item' href='?module=laporan&act=total1'>Total Stok</a>
			<a class='list-group-item' href='?module=laporan&act=toprank1'>Top Rank</a>
			<a class='list-group-item' href='?module=laporan&act=aging1'>Aging'</a>
			<a class='list-group-item' href='?module=laporan&act=po'>Purchase Order'</a>
	</div>";
	break;
...
// ambil daftar nama kasir
	...
	case 'diskon1':
		...
		<form method=GET action='?module=laporan'>
			...
			<tr>
				<td>(d) Dari Tanggal</td>
				<td><input type='text' class='form-control' class="tanggalan" name='DariTanggal' value='<?php echo date("d-m-Y 00:00"); ?>' accesskey='d'></td>
			</tr>
			<tr>
				<td>Sampai Tanggal</td>
				<td><input type='text' class='form-control' class="tanggalan" name='SampaiTanggal' value='<?php echo date("d-m-Y 23:59"); ?>'></td>
			</tr>
			<tr>
				<td>Pilih Kasir</td>
...
//			<form method= POST action= '?module=laporan&act=aksi&action=cetakjual2'>
			...
			<table>
				<tr>
					...
					<td>
						<select class="form-control" name="layoutStruk">
			...
			<br /><br /><a href= javascript:history.go(-1)><i class='fa fa-arrow-circle-o-left'></i>Kembali</a>
			<?php
		} // if ($_GET[action]== 'cetakjual1')
...
//			WHERE b.jumBarang >0 AND b.barcode= d.barcode";
	...
	case 'toprank1': { // ---------------------------------------------------------------------------------
		...
		<table>
			<tr>
			<td>Dari Tanggal</td>
			<td><input type='text' class='form-control' name=dari value='$tanggal'>
			</td>
		</tr>

			<tr>
			<td>Sampai Tanggal</td>
			<td><input type='text' class='form-control' name=sampai value='$tanggal'>
			</td>
		</tr>
			...
			<tr>
			<td>Jumlah Item</td>
			<td><input type='text' class='form-control' name=jumlah value='200'>
			</td>
		</tr>
			...
			<td><select class='form-control' name='sortir'>
				...
				<tr><td colspan=2><input type='submit' class='btn btn-default' value='Buat Laporan'></td></tr>
		</table>
	...
	case 'jumlahpoin':
		...
		<form method="POST" target="_blank" action="./aksi.php?module=laporan&act=jumlahpoin">
			...
			<tbody>
				<tr>
					<td>Tahun:</td>
					<td><input type="text" class="form-control" name="laporan[tahun]" placeholder="yyyy" size="4" value="<?php echo date('Y'); ?>" autofocus="autofocus"/></td>
					<td>Periode:</td>
					<td>
						<select class="form-control" name="laporan[periode]">
						<?php
					...
					<td>Sort by:</td>
					<td>
						<select class="form-control" name="laporan[sort]">
					...
					<td>
						<input type="text" class="form-control" name="laporan[jumlahDari]" value="0" size="1"/>
					</td>
					<td>sampai</td>
					<td>
						<input type="text" class="form-control" name="laporan[jumlahSampai]" value="9999" size="1"/>
					</td>
					<td colspan="7"></td>
	...
	case 'transferbarang':
		...
		<form method=POST action='?module=laporan&act=transferbarang2'>
			...
			<tr>
				<td><b>C</b>ustomer:</td>
				<td>
					<select class="form-control" name="customer" accesskey="c" autofocus="autofocus">
			...
			<tr>
				<td colspan="2" style="text-align: right"><input type='submit' class='btn btn-default' name="transfer" value='Submit'></td>
			</tr>
			</table>
		</form>
		<script>
