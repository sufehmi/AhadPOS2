...
switch ($_GET[act]) {
	...
	default:
		...
		<form method=POST action='?module=menu&act=tambahmenu'>
			<input type='submit' class='btn btn-default' value='Tambah Menu'>
		</form>
		<form method=POST action='?module=menu&act=listicon'>
			<input type='submit' class='btn btn-default' value='List Icon'>
		</form>
	...
	case "tambahmenu":
		...
		<form method=POST action='./aksi.php?module=menu&act=input'>
			<table>
				<tr>
					<td>Nama Menu</td>
					<td><input type='text' class='form-control' name='nama' size=30></td>
				</tr>
				<tr>
					<td>Parent</td>
