...
<a class='list-group-item' href='?module=pembelian_barang&act=pembelianbarang' accesskey='b'>Pembelian Barang</a>
<a class='list-group-item' href='?module=pembelian_barang&act=laporanpembeliantanggal' accesskey='l'>Laporan Pembelian per Tanggal</a>
<a class='list-group-item' href='?module=pembelian_barang&act=laporanpembelian' accesskey='s'>Laporan Pembelian per Supplier</a>
<a class='list-group-item' href='?module=pembelian_barang&act=pemesananbarang' accesskey='p'>Pemesanan Barang</a>
<a class='list-group-item' href='?module=pembelian_barang&act=returpembelianpernota' accesskey='r'>Retur Pembelian per Nota</a>
<a class='list-group-item' href='?module=pembelian_barang&act=returpembelianperbarang' accesskey='t'>Retur Pembelian per Barang</a>
<a class='list-group-item' href='?module=pembelian_barang&act=cetakretur' accesskey='c'>Cetak Nota Retur</a>
<a class='list-group-item' href='?module=pembelian_barang&act=inputeprocurement1'>Input Beli Otomatis</a>
<a class='list-group-item' href='?module=pembelian_barang&act=buatrpo1' accesskey='o'>Buat RPO</a>
<a class='list-group-item' href='?module=pembelian_barang&act=rposup1'>Buat RPO Per Supplier</a>
</div>
...
case "cetakretur"; //=========================================================================================================================
	...
	if ($_GET[action]== 'lihatlaporan') {
		...
		case "returpembelianperbarang"; //=======================================================================================================================
			...
			<br/>
			<input type='submit' class='btn btn-default' value='(p) Pilih Supplier' name='cariSupplier' accesskey='p'/>
			</form>
			<?php
			break;
				...
				<tr><th>NO</th><th>Id Barang</th><th>Nama Barang</th><th>Tgl Expire</th><th>Jumlah</th><th>Harga Beli</th><th>Total</th><th>Jumlah<br />RETUR</th><th>AKSI</th></tr>";
					...
					while ($dataDetail= mysql_fetch_array($detail)) {
						...
						echo "<td class=td>$no</td>
							...
							<td class=td><input type='text' class='form-control' name=tglExpire size=8		readonly 	value=$dataDetail[tglExpire]></td>
							<td class=td align=right><input type='text' class='form-control' name=jumBarang size=3 readonly 	value=$dataDetail[jumBarang]></td>
							<td class=td align=right><input type='text' class='form-control' name=hargaBeli size=8 readonly 	value=$dataDetail[hargaBeli]></td>
							<td class=td align=right>".uang($subTotal)."</td>
				<td class=td align=center><input type='text' class='form-control' name=jumRetur size=3		value=$dataDetail[jumRetur]></td>
			<td class=td align=right>
		...
		<td align=right class=td>".uang($totalRetur)."</td>
			...
			if (mysql_num_rows($detail) != 0) {
				...
				<table class="tabel">
					...
					while ($dataDetail= mysql_fetch_array($detail)) :
						...
						<td><?php echo $dataDetail['idBarang']; ?></td>
						<td><?php echo $dataDetail['namaBarang']; ?></td>
						<td><input type='text' class='form-control' name=tglExpire value=<?php echo $dataDetail['tglExpire']; ?>></td>
						<td class="right"><input type='text' class='form-control' name=jumBarang value=<?php echo $dataDetail['jumBarang']; ?>></td>
						<td class="right"><input type='text' class='form-control' name=hargaBeli value=<?php echo $dataDetail['hargaBeli']; ?>></td>
						<td class="right"><?php echo uang($subTotal); ?></td>
						<td class="right">
			...
			<table>
				...
				<form method="POST" action="?module=pembelian_barang&act=carisupplier&action=cek&idSupplier=<?php echo $_SESSION['idSupplier']; ?>">
					...
					<td>
						<input type='submit' class='btn btn-info' value="(2) Pilih barcode !" accesskey="2" />
			...
			<div id="frmTambahBarang">
				<form method="POST" action="?module=pembelian_barang&act=carisupplier&action=tambah">
					...
					<table>
						...
						<td><input type='text' class='form-control' name='jumBarang' id='jumBarang' tabindex=1 accesskey='j'/></td>
						</tr>
						<tr>
						<td>Nama Barang</td>
						<td><input type='text' class='form-control' name='namaBarang' value='<?php echo $barang['namaBarang']; ?>' readonly='readonly' /></td>
						<td>Subtotal (Rp)</td>
						<td><input type='text' class='form-control' name='subtotal' value='0' id='xsubtotal' tabindex=2 /></td>
						</tr>
						<tr>
						<td>Diskon (%)</td>
						<td><input type='text' class='form-control' name='xDiskonPersen' value='<?php echo $_POST['xDiskonPersen']; ?>' id='xDiskonPersen' tabindex="3" /></td>
						<td>PPN (%)</td>
						<td><input type='text' class='form-control' name='xppn' value='<?php echo $_POST['xppn']; ?>' id='xppn' tabindex=5 /></td>
						</tr>
						<tr>
						<td>Diskon (Rp)</td>
						...
						<td><input type='text' class='form-control' name='hargaJualLama' value='<?php echo $barang['hargaJual']; ?>' readonly='readonly' /></td>
						<td>Harga Jual Barang</td>
						<td><input type='text' class='form-control' name='hargaJualBaru' id='hargaJualBaru' value='<?php echo $barang['hargaJual']; ?>' tabindex=9 /></td>
						</tr>
						<tr>
						<td colspan=2>&nbsp</td>
						<td>Tanggal Expire (yyyy-mm-dd)</td>
						<td><input type='text' class='form-control' name='tglExpire' size=10 tabindex=10 /></td>
						</tr>
						<tr>
						<td>Harga Banded</td>
			...
			if ($r) { // -------------------- tampilkan data yang sudah di input sejauh ini ---------
				...
				ORDER BY idBarang";
					...
					while ($data= mysql_fetch_array($query2)) {
						...
						<td align=right><input type='text' class='form-control' name=jumlahBarang value="<?php echo $data['jumBarang']; ?>" size=5></td>
...
//fixme: tombol update membuat jumlah stok jadi sama semua
				...
				echo "</select></td></tr>
						<tr><td width=65% align=right>Tanggal Pembayaran (hutang)</td><td align=right><input type='text' class='form-control' name='tglBayar' tabindex=17></td></tr>
						<tr><td width=65% align=right>Nomor Invoice</td><td align=right><input type='text' class='form-control' name='NomorInvoice' value=0 tabindex=18></td></tr>
						<tr><td width=65% align=right>Tanggal Invoice</td><td align=right><input type='text' class='form-control' name='TanggalInvoice'
			value='".date("Y-m-d")."' tabindex=19></td></tr>
			<tr><td width=65% align=right>Diskon (%)</td><td align=right><input type='text' class='form-control' id='diskonpersen' name='DiskonPersen' value=0 tabindex=20></td></tr>
			<tr><td width=65% align=right>Diskon (Rp)</td><td align=right><input type='text' class='form-control' id='diskonrupiah' name='DiskonRupiah' value=0 tabindex=21></td></tr>
			<tr><td width=65% align=right>PPn (%)</td><td align=right><input type='text' class='form-control' id='ppn' name='PPN' value=0 tabindex=22></td></tr>";
		...
		";
			...
			if (($handle= fopen($csvfile, "r")) !== FALSE) {
				...
				<tr style='background-color:{$warna}'>
					<td><input type='text' class='form-control' name=barcode$n value='".$data[0]."' size=10 readonly>
					</td>
					<td><center><input type='text' class='form-control' name=namabarang$n value='".$data[2]."' readonly>
					</td>
					<td><input type='text' class='form-control' name=jumlah$n value='".$data[3]."' size=2 readonly>
					</td>
					<td><input type='text' class='form-control' name=harga$n value='".$data[5]."' size=5 readonly>
					</td>
					<td><center>$hargaSekarang
					</td>
					<td bgcolor=#dddddd><input type='text' class='form-control' name=rrp$n value='".$data[6]."' size=5>
					</td>
					<td><input type='text' class='form-control' name=satuan$n value='".$data[7]."' size=2 readonly>
					</td>
					<td><input type='text' class='form-control' name=kategori$n value='".$data[8]."' size=6 readonly>
					</td>
				</tr>
				";
						$n++;
		...
		<input type=hidden name=supplierid value='".$_POST['supplierid']."'>";
			...
			<table>
				...
				<tr>
					...
					<td><input type='text' class='form-control' size=4 name=periode value='<?php echo $x['interval']; ?>'>hari</td>
				</tr>
				<?php
				/*
					<tr>
					<td>Range analisa penjualan</td>
					<td><input type='text' class='form-control' size=4 			name=range value='30'>hari</td>
					</tr>
				*/
				?>
				<tr>
					<td>Jumlah pemesanan</td>
					<td>untuk persediaan<input type='text' class='form-control' size=4 name=persediaan value='<?php echo $x['interval']; ?>'>hari</td>
				</tr>
	...
	<tr><td>Buffer Stock</td>
		<td><input type='text' class='form-control' size=4 			name=buffer value='30'>%</td>
	</tr>

	<tr><td></td>
		<td>Periode delivery Supplier</td>
		<td><input type='text' class='form-control' size=4 			name=periode 		id=periode		value='".$x['interval']."' readonly>hari</td>
	</tr>

	<tr><td></td>
		<td>Pesanan tiba di Gudang</td>
		<td><input type='text' class='form-control' size=4 			name=tibagudang 	id=tibagudang	value='2' onBlur='RecalcTotal(1)'>hari</td>
	</tr>

	<tr><td></td>
		<td>Pesanan tiba di Toko</td>
		<td><input type='text' class='form-control' size=4 			name=tibatoko 		id=tibatoko		value='3' onBlur='RecalcTotal(1)'>hari</td>
	</tr>
	...
	<tr><td>Jumlah pemesanan</td>
		...
		<td><input type='text' class='form-control' size=4 			name=persediaan 	id=persediaan	value='".($x['interval'] + 2 + 3)."'>hari</td>
	</tr>
...
//HS ditaruh paling bawah agar tidak mengacaukan form yang lainnya
		...
		<div id="layer1">
			...
			<script>
				...
				echo "
				<table>
					<tr><td>*<u>B</u>arcode</td><td><input type='text' class='form-control' accesskey='b' name='barcode' id='barcode' size=30 value='$_GET[id]' tabindex=24>
				</td></tr>


					<tr><td>* Nama Barang</td><td><input type='text' class='form-control' name='namaBarang' id='tambahbarang-namabarang' size=30 maxlength=30 tabindex=25></td></tr>
					<tr><td>* Supplier</td>
			...
			<tr background=#666666><td>Subtotal</td><td><input type='text' class='form-control' name='subtotal' id='subtotal' value=0 tabindex=30 /></td></tr>
			<tr background=#666666><td>* Jumlah Barang</td><td><input type='text' class='form-control' name='jumBarang' id='tjumBarang' value=1 tabindex=31 /></td></tr>
			<tr background=#666666><td>PPN</td><td><input type='text' class='form-control' name='ppn' id='bppn' value='10' tabindex=32 />%</td></tr>
			<tr background=#666666><td>% Profit</td><td><input type='text' class='form-control' value='0' name='PersenProfit' id='PersenProfit' tabindex=33 /></td></tr>

			<tr><td>* Harga Beli Barang</td><td><input type='text' class='form-control' name='hargaBeli' id='hargaBeli' value=0 tabindex=34 /><a href='#' onclick=\"RecalcHargaBarangBaru();\" accesskey='h'>(h)<i><b>H</b></i>itung Harga</td></tr>
