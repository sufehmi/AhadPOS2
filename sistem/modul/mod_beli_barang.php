   ...
   default:
      echo "<h2>Pembelian Barang</h2>
		...
		<tr>
			...
			<input type=submit value='(l) Laporan Pembelian per Tanggal' accesskey='l'>
			</form>
                    </td>
                    <td>
			<form method=POST action='?module=pembelian_barang&act=laporanpembelian'>
			<input type=submit value='(s) Laporan Pembelian per Supplier' accesskey='s'>
			</form>
                    </td>
                    <td>
		...
		<tr>
                    <td>
			<form method=POST action='?module=pembelian_barang&act=returpembelianpernota'>
			<input type=submit value='(r) Retur Pembelian per Nota' accesskey='r'>
			</form>
                    </td>
                    <td>
			<form method=POST action='?module=pembelian_barang&act=returpembelianperbarang'>
			<input type=submit value='(t) Retur Pembelian per Barang' accesskey='t'>
			</form>
                    </td>
                    <td>
		...
		<td align=right class=td>".uang($totalRetur)."</td>
                  ...
                  <table class="tabel">
                     ...
                     while ($dataDetail = mysql_fetch_array($detail)) :
                        ...
                        <form method=POST action='?module=pembelian_barang&act=editlaporan&action=ubahdata&idnota=<?php echo $idNota; ?>'>
                           <td><?php echo $dataDetail['idBarang']; ?></td>
                           <td><?php echo $dataDetail['namaBarang']; ?></td>
                           <td><input type=text name=tglExpire value=<?php echo $dataDetail['tglExpire']; ?>></td>
                           <td class="right"><input type=text name=jumBarang value=<?php echo $dataDetail['jumBarang']; ?>></td>
                           <td class="right"><input type=text name=hargaBeli value=<?php echo $dataDetail['hargaBeli']; ?>></td>
                           <td class="right"><?php echo uang($subTotal); ?></td>
                           <td class="right">
            ...
            case "pembelianbarang": // =================================================================================================================
               ...
               <form method=POST action='?module=pembelian_barang&act=carisupplier'>
                  <select name="idSupplier" style="width:30%">
                     <?php
               ...
               <div id="frmTambahBarang">
                  <form method="POST" action="?module=pembelian_barang&act=carisupplier&action=tambah">
                     ...
                     <table>
                        ...
                        <tr>
                           <td>Nama Barang</td>
                           <td> : <input type=text name='namaBarang' value='<?php echo $barang['namaBarang']; ?>' readonly='readonly' /></td>
                           <td>Subtotal (Rp)</td>
                        ...
                        <tr>
                           ...
                           <td> : <input type=text name='hargaJualLama' value='<?php echo $barang['hargaJual']; ?>' readonly='readonly' /></td>
				...
				ORDER BY idBarang";
                     ...
                     while ($data = mysql_fetch_array($query2)) {
                        ...
                        <form method=POST action='?module=pembelian_barang&act=carisupplier&action=ubahjumlah'>
                           ...
                           <td align=right><input type=text name=jumlahBarang value="<?php echo $data['jumBarang']; ?>" size=5></td>
